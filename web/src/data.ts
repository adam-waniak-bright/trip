    ...
    options: [
      {
        ...
        url: 'https://www.booking.com/searchresults.html?ss=Levanto&group_adults=4&checkin=2026-09-12&checkout=2026-09-15',
      ...
      },
      {
        ...
        url: 'https://www.booking.com/searchresults.html?ss=Levanto+hotel&group_adults=4&checkin=2026-09-12&checkout=2026-09-15',
...
export const days: DayPlan[] = [
  ...
  },
  {
    ...
    route: '530 km | ~6-6.5h',
    desc: 'Przystanek w Sirmione nad Garda - zamek Scaligero na wodzie, ruiny rzymskie, obiad. Po poludniu dojazd do Levanto (baza na 3 noce).',
    ...
    attractions: [
      { name: 'Sirmione', desc: 'Przystanek nad Garda: zamek Scaligero (XIII w.) na wodzie, Grotte di Catullo, obiad', longDesc: 'Polwysep wcinajacy sie w Jezioro Garda z XIII-wiecznym zamkiem Scaligero na wodzie. Na czubku polwyspu ruiny rzymskiej willi Grotte di Catullo (I w. p.n.e.) z pieknymi widokami na jezioro. Waskie uliczki z lodziarniami i sklepami. Idealny przystanek na obiad w polowie trasy do Cinque Terre. Wejscie do zamku ~8 EUR.', cost: 'Zamek ~8 EUR/os', duration: '2-2.5h przystanek', mapsQuery: 'Sirmione Castle' },
    ],
    tips: [
      'Pelny dzien jazdy (~530 km) - wczesny wyjazd z Brixen (~8:00), zeby dotrzec do Levanto przed wieczorem',
      'Sirmione lezy najlepiej na trasie na zachod (A4) - lepszy przystanek niz Bardolino',
